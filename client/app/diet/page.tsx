...
import { Activity, Apple, RefreshCw, CheckCircle2, Droplet, Coffee, Utensils, Sun, Moon } from 'lucide-react';
      ...
      <div className="flex-1 overflow-y-auto px-6 py-8 md:px-10 z-10 relative">
        ...
        {loading ? (
          <div className="flex items-center justify-center h-[300px] text-neon-green">
            ...
            <span className="ml-3 font-bold">Scaling caloric calculations...</span>
          </div>
        ) : !plan || !plan.meals ? (
